// Unauthorized Absence List View — wider Employee Name column (~220px)
// Same as Disciplinary Case: dynamic column index by header text (not hardcoded nth-child)
// Reason: prod vs local list order can differ, hardcoded nth-child styles wrong column.
frappe.listview_settings["Unauthorized Absence"] = {
  refresh(listview) {
    const apply = () => {
      ...
      const styleId = "unauthorized-absence-employee-name-width";
