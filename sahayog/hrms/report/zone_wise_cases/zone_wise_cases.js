...
//     // Prepare safe date args
//     const date_args = (from_date && to_date) 
//         ? `args.issue_occurrence_date = ['between', '${from_date}|${to_date}'];` 
//         : "";

//     const color = color_map[column.fieldname];
//     const status = status_map[column.fieldname];

//     // Assign index for click handler
...
//                 eval(date_args);    // applies date filter only if valid
