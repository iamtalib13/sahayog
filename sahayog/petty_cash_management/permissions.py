...
def get_user_allowed_branches(user=None):
    ...
    if 'Administrator' in user_roles or 'System Manager' in user_roles or any(r in user_roles for r in ["HO Petty Cash Manager", "HO Petty Cash Approver", "HO Petty Cash Verifier", "HO Petty Cash Auditor",]):
        return None
