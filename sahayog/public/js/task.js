...
frappe.ui.form.on("Task", {
  refresh: function (frm) {
    ...
    frappe.call({
      method: "sahayog.api.custom_api.get_active_users_list",
      args: {
        exclude_users: JSON.stringify(["Guest", "Administrator"]),
        limit: 100, // Load only 100 users initially for performance
      },
      callback: function (r) {
    ...
    frappe.call({
      method: "sahayog.api.custom_api.is_user_assigned",
      args: { task_name: frm.doc.name, user: frappe.session.user },
      callback: function (r) {
          ...
          frm.add_custom_button(__("Assign to Users"), () => {
            const dialog = new frappe.ui.Dialog({
              ...
              primary_action: function () {
                ...
                frappe.call({
                  method: "sahayog.api.custom_api.assign_task_to_users",
                  args: { task_name: frm.doc.name, users: selectedUsers },
                  callback: function () {
                    frappe.msgprint({
                      title: __("Success"),
                      indicator: "green",
                  ...
                  error: function () {
                    frappe.msgprint({
                      title: __("Error"),
                      indicator: "red",
                      message: __("Failed to assign task"),
                    });
                  },
                });
              },
            ...
            const listContainer = $(
              dialog.fields_dict.users_list_section.wrapper
            ...
            function renderSelectedUsers() {
              ...
              if (selectedUsers.length === 0) {
                ...
                selectedUsers.forEach((userId) => {
                  // Find user in current displayed list or all known users
                  const user =
              ...
              selectedContainer
                ...
                .on("click", function () {
                  ...
                  // Remove from backend
                  frappe.call({
                    method: "sahayog.api.custom_api.remove_task_assigned_user",
                    args: { task_name: frm.doc.name, users: [userId] },
                    callback: function () {
            ...
            function renderUsersList(users) {
              currentDisplayedUsers = users; // Store currently displayed users
              let html = "";
              users.forEach((u) => {
            ...
            function updateSelectAllCheckbox() {
              const allVisibleSelected =
                ...
                currentDisplayedUsers.every((user) =>
            ...
            dialog.fields_dict.search_user.$input.on("input", function () {
              ...
              if (searchText.length === 0) {
                // Show initial users when search is cleared
                renderUsersList(initialUsers);
                return;
              }
